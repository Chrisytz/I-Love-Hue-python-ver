...
def runGame(rect_id, circle_id):
    ...
    '''
    [[[[(27, 74, 94), (0, 0)], [(55, 156, 147), (1, 0)], [(255, 226, 223), (0, 1)],
                     [(223, 255, 235), (1, 1)]], [[(29, 74, 82), (0, 0)]], [(239, 143, 149), (1, 0)],
                    [(130, 202, 193), (0, 1)], [(255, 241, 242), (1, 1)]],
                   [[(255, 168, 192), (0, 0)], [(255, 234, 237), (1, 0)], [(64, 99, 118), (0, 1)],
                    [(69, 173, 157), (1, 1)]],
                   [[(255, 248, 249), (0, 0)], [(255, 116, 151), (1, 0)], [(84, 176, 163), (0, 1)],
                    [(10, 46, 65), (1, 1)]],
                   [[(73, 166, 162), (0, 0)], [(218, 255, 194), (1, 0)], [(32, 58, 69), (0, 1)],
                    [(255, 198, 205), (1, 1)]],
                   [[(255, 168, 192), (0, 0)], [(255, 234, 237), (1, 0)], [(32, 78, 57), (0, 1)],
                    [(111, 209, 193), (1, 1)]],
                   [[(55, 130, 136), (0, 0)], [(255, 203, 205), (1, 0)], [(167, 255, 235), (0, 1)],
                    [(196, 222, 168), (1, 1)]],
                   [[(44, 119, 121), (0, 0)], [(127, 239, 244), (1, 0)], [(255, 203, 219), (0, 1)],
                    [(176, 192, 163), (1, 1)]],
                   [[(33, 115, 115), (0, 0)], [(141, 205, 137), (1, 0)], [(255, 226, 223), (0, 1)],
                    [(223, 255, 235), (1, 1)]]],[[[(211, 90, 63), (0, 1)], [(148, 41, 110), (1, 1)],
                    '''
    colour_list = [
